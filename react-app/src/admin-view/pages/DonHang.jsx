  ...
  const cards = [
    {
      ...
      amount: totalData?.results3?.[0]?.tong_tien_hom_nay || 0,
    },
    {
      icon: "bi-bar-chart",
      title: "Tiền bán tháng này",
      amount: totalData?.results4?.[0]?.tong_tien_thang_nay || 0,
    },
    {
      icon: "bi-graph-down",
      title: "Tổng tiền",
      amount: totalData?.results?.[0]?.tong_tien || 0,
    },
    {
      icon: "bi-pie-chart-fill",
      title: "Khách mua nhiều nhất",
      amount: totalData?.results2?.[0]?.ten_khach_hang || "không có",
    },
  ];
  ...
  const chartOptions = {
    ...
    plugins: {
      ...
      title: {
        ...
        text: "Sales Over Months", // Tiêu đề biểu đồ
        font: {
      ...
      <div>
        ...
        <Grid container spacing={3} marginTop={3}>
          ...
          <Grid item xs={12} md={4}>
            ...
            >
              <h3 style={{ color: "#c9d1d9" }}>Amount Chart</h3>
              <Doughnut
                data={doughnutData}
                options={options}
                style={{
